        ...
        <div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
                ...
                <div class="bg-white dark:bg-gray-800 overflow-hidden shadow-sm sm:rounded-lg">
                    <div class="p-6">
                        ...
                        <div class="grid grid-cols-2 gap-4">
                            <a href="{{ route('complaints.index') }}?contractor_id={{ auth()->id() }}" class="flex items-center p-3 bg-blue-50 dark:bg-blue-900/20 rounded-lg hover:bg-blue-100 dark:hover:bg-blue-900/30 transition">
                            ...
                            <a href="{{ route('complaints.index') }}?status=pending&contractor_id={{ auth()->id() }}" class="flex items-center p-3 bg-yellow-50 dark:bg-yellow-900/20 rounded-lg hover:bg-yellow-100 dark:hover:bg-yellow-900/30 transition">
                                <svg class="w-6 h-6 text-yellow-600 mr-3" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                    <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M12 8v4l3 3m6-3a9 9 0 11-18 0 9 9 0 0118 0z"></path>
                                </svg>
                                <span class="text-sm font-medium text-gray-900 dark:text-gray-100">Menunggu Kerja</span>
                            </a>
                            <a href="{{ route('reports.summary') }}" class="flex items-center p-3 bg-purple-50 dark:bg-purple-900/20 rounded-lg hover:bg-purple-100 dark:hover:bg-purple-900/30 transition">
                                ...
                                <span class="text-sm font-medium text-gray-900 dark:text-gray-100">Laporan Kerja</span>
                            </a>
            ...
            <div class="bg-white dark:bg-gray-800 overflow-hidden shadow-sm sm:rounded-lg">
                <div class="p-6">
                    ...
                    <div class="mt-4">
                        <a href="{{ route('complaints.index') }}?contractor_id={{ auth()->id() }}" class="text-blue-600 hover:text-blue-800 text-sm font-medium">
                            Lihat semua tugasan →
                        </a>
                    </div>
                </div>
            ...
            <div class="bg-white dark:bg-gray-800 overflow-hidden shadow-sm sm:rounded-lg">
                <div class="p-6 text-center">
                    ...
                    <p class="text-gray-600 dark:text-gray-400">Belum ada tugasan yang diberikan kepada anda.</p>
                </div>
            </div>
            @endif
        </div>
